...
import com.example.eadmincraftzone.databinding.ImageItemBinding

class AddProductImageAddapter (val list : ArrayList<Uri>)
    : RecyclerView.Adapter<AddProductImageAddapter.AddProductImageViewHolder>() {
